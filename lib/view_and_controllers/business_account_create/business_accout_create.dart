                ...
                child: Column(
                 ...
                 mainAxisSize: MainAxisSize.min,
                  children: [
                    ...
                    Text("Create a business account before creating a deal",style: textStyleWidget(fontSize: FontSize.normalText),textAlign: TextAlign.center,),
                    ...
                    Text("Enter UserName",style: textStyleWidget(fontSize: FontSize.subText_01),textAlign: TextAlign.start,),
                    ...
                    Text("Enter BusinessMail",style: textStyleWidget(fontSize: FontSize.subText_01),textAlign: TextAlign.start,),
                    ...
                    TextFormField(
                      ...
                      validator: (text){
                        ...
                        if(!GetUtils.isEmail(text!) || text.isEmpty || text==null)
                        {
                    ...
                    Padding(
                      ...
                      child: MaterialButton(
                          ...
                          child:controller.isLoading ? SizedBox(width: 15,height: 15,child: CircularProgressIndicator(color: Colors.white,),): Row(
                            mainAxisAlignment: MainAxisAlignment.center,

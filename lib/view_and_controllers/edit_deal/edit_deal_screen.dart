...
class EditDeal extends GetView<EditDealController> {
  String dealUniqId;

  @override
  Widget build(BuildContext context) {
    controller.init(dealUniqId);

    return GetBuilder<EditDealController>(
      //  init:EditDealController(shopdata: dealUniqId),
      builder: (EditDealController controller) {
        return Scaffold(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: TextField(
                            controller:
                                controller.BusinessEmailAddressController,
  ...
  EditDeal({required this.dealUniqId});
}
